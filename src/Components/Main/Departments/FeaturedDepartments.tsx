    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {departments.map((dept, index) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-[#0E3293] mb-2">{dept.name}</h3>
            <p className="text-gray-700 mb-4">{dept.description}</p>
            <button className="text-[#0E3293] font-medium hover:underline flex items-center">
              Learn more
      ...
      <div className="mt-12 text-center">
        <button
          ...
          ] hover:bg-[#1976D2] text-white px-8 py-3 rounded-full transition-colors text-lg font-medium"
        >
