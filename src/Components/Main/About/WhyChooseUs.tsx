  ...
  return (
    <div className="container mx-auto">
      <div className="text-center mb-16">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-[#0E3293] mb-3">Why Choose HYGO Healthcare</h2>
      </div>
        ...
        {features.map((feature, index) => (
          ...
          >
            <div className="flex items-start mb-4">
              ...
              <h3 className="text-xl font-bold mb-2 text-[#0E3293]">Vision Point {index + 1}</h3>
            </div>
      ...
      <div className="mt-16 bg-gradient-to-r from-[#E3F2FD] to-[#E8F5E9] p-8 rounded-xl">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-2/3 mb-6 md:mb-0 md:pr-8">
            <h3 className="text-2xl font-bold text-[#0E3293] mb-4">Our Commitment to Appearance</h3>
          ...
          <div className="md:w-1/3 flex justify-center">
            <div className="w-48 h-48 bg-[#0E3293] rounded-full flex items-center justify-center text-white text-center p-4">
              <div>
