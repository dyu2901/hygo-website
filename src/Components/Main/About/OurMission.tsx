  ...
  return (
    <div className="py-16 bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl">
      <button
        ...
        className="mb-6 px-10 py-2 text-[#0E3293] hover:text-[#1976D2] font-medium transition-colors flex items-center"
      >
        <svg
      ...
      <h2 className="text-4xl font-bold mb-6 text-center text-[#0E3293]">Our Mission</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-8">
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-[#0E3293]">Mission Point {i}</h3>
